...
const home = {
  ...
  featured: {
    ...
    title: (
      <>
        Recent project: <strong className="ml-4">3D Sign Language Learning App</strong>
      </>
    ),
    href: '/work/Advanced-Sign-Language-Recognition-Interactive-3D-E-Learning-Platform',
  },
  subline: (
    <>
    ...
    experiences: [
      {
        ...
        achievements: [
          <>
            Developed a real-time sign language recognition system using <strong>FastAI</strong>,
            trained on multilingual gesture datasets (ASL, Urdu ASL, numbers).
          </>,
          <>
            Integrated <strong>React Three Fiber</strong> and <strong>Three-VRM</strong> to animate
            3D avatars based on ML predictions for immersive feedback.
          </>,
          <>
            Engineered a secure, scalable backend using <strong>Supabase (PostgreSQL)</strong> for
            user auth, content delivery, and progress tracking.
          </>,
          <>
            Seamlessly connected model inference to the frontend for{' '}
            <strong>live gesture-to-animation mapping</strong> using structured JSON pipelines.
          </>,
        ],
        images: [
          {
      ...
      },
      {
        ...
        achievements: [
          <>
            Engineered a modular MERN backend with TypeScript to support RFID-based school
            attendance tracking.{' '}
          </>,
          <>
            Integrated RFID hardware and REST APIs to track student check-ins across school vendors.
          </>,
          <>Implemented RBAC with JWT for user, parent, and teacher access control.</>,
          <>
            Set up WhatsApp and email alerts for real-time attendance events using Mailtrap for
            testing.
          </>,
        ],
        images: [
          {
            src: '/images/projects/scrypthub/exp.png',
            alt: 'image',
            width: 16,
            height: 9,
          },
      ...
      {
        company: 'VIP Recruitment',
        timeframe: 'June 2025',
        role: 'Full Stack Developer',
        achievements: [
          <>
            Developed a full-stack VIP Recruiting platform with role-based access for Admins,
            Employees, and Recruits using the MERN stack and ShadCN UI.
          </>,
          <>
            Implemented a secure ToS workflow, allowing admins to upload documents and recruits to
            sign them during onboarding.{' '}
          </>,
          <>
            Built a structured assignment and feedback system with three training levels,
            performance tracking, and final evaluation reports.
          </>,
          <>
            Delivered real-time messaging using TanStack Query with zero caching, avoiding Socket.IO
            per client constraints while maintaining smooth UX.
          </>,
        ],
        images: [
          {
            src: '/images/projects/vip/vip_0.png',
            alt: 'image',
            width: 16,
            height: 9,
          },
      ...
      },
      {
        ...
        achievements: [
          ...
          <>
            Integrating Mailtrap (for testing) and SendGrid (for production) for robust email
      ...
      },
      {
        ...
        achievements: [
          <>
            Developed a responsive <strong>real-time inventory management system</strong> using{' '}
            <strong>Google AppSheet</strong>, enabling seamless multi-device access and operational
            oversight.
          </>,
          <>
            Integrated <strong>BigQuery</strong> for scalable backend data handling and{' '}
            <strong>live reporting dashboards</strong> to support informed supply chain decisions.
          </>,
          <>
            Automated workflows for{' '}
            <strong>stock alerts, purchase orders, and supplier coordination</strong>, significantly
            reducing manual overhead.
          </>,
          <>
            Helped replace costly third-party systems like Zoho and NetSuite with a{' '}
            <strong>lightweight, AI-assisted internal tool</strong> tailored to business logic.
          </>,
        ],
        images: [
          {
      ...
      },
      {
        ...
        achievements: [
          <>
            Engineered scalable e-commerce pages using <strong>Next.js</strong>,{' '}
            <strong>Saleor</strong>, and <strong>GraphQL</strong>, with dynamic catalog features
            like filtering, pagination, and personalized recommendations.
          </>,
          <>
            Integrated <strong>JazzCash</strong> for secure, localized payment processing, ensuring
            smooth UX and data privacy compliance.
          </>,
          <>
            Built and styled a fully responsive UI from <strong>Figma</strong> designs using{' '}
            <strong>Headless UI</strong> and <strong>Tailwind CSS</strong> for consistent
            multi-device performance.
          </>,
          <>
            Developed a basic <strong>RAG-based AI assistant</strong> using{' '}
            <strong>LangChain</strong> and <strong>Ollama</strong> with vector embeddings to help
            customers browse and find products intelligently.
          </>,
        ],
        images: [
          {
...
const gallery = {
  ...
  images: [
    ...
    {
      src: '/images/projects/vip/vip_8.png',
      alt: 'image',
      orientation: 'horizontal',
    },
    {
      src: '/images/projects/vip/vip_7.png',
      alt: 'image',
      orientation: 'horizontal',
    },
    {
      src: '/images/projects/vip/vip_6.png',
      alt: 'image',
      orientation: 'horizontal',
    },
    {
